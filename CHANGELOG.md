...
### Fixed
- Register default and mapstructure decode hooks for `auth.backchannel_allowed_cidrs` to support comma-separated CIDR environment variables.

## [1.5.6] - 2026-09-02

### Fixed
- Fix linter, variable shadowing, and staticcheck issues across auth and oauth2 controllers.
...
### Fixed
- Remove obsolete bearer-token browser-cookie helpers and refresh-cookie fallback so CI and the current opaque SSO session boundary use one implementation.
